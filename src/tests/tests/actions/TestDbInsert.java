...
/**
 * Implementiert die Test für die Aktion {@link haushaltsbuch.actions.DbInsert}.
 * 
...
public class TestDbInsert {
	/**
	 * Speichert die Instanz von DbNew
	 */
	private DbInsert _test;
	...
	/**
	 * Es wird überprüft, ob die Klasse {@link haushaltsbuch.actions.DbInsert} von
	 * der Klasse {@link haushaltsbuch.actions.Action} abgeleitet wurde.
	 */
	@Test
	public void testDbNewInheritedAction() {
		assertEquals("haushaltsbuch.actions.Action",
				DbInsert.class.getSuperclass().getName());
	}
	...
	public void testCommandIsRight() {
		assertEquals(DbInsert.COMMAND, _test.getValue(Action.ACTION_COMMAND_KEY));
	}
	...
	public void testNameIsRight() {
		assertEquals("Neu", _test.getValue(Action.NAME));
	}
	...
	public void testCommandStringIsRight() {
		assertEquals("DatabaseInsert", DbInsert.COMMAND);
	}
}
