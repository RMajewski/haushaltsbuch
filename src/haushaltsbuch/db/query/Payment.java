...
/**
 * Enthält die Datenabnk-Abfragen für die Tabelle 'payment'.
 * 
 ...
 * @since 0.4
 */
public class Payment extends Query {
	/**
	...
	/**
	 * Gibt die Datenbank-Abfrage zurück, die die Tabelle "payment" erzeugt.
	 * 
	 * @return Datenbank-Abfrage, um die Tabelle "payment" zu erzeugen.
	 */
	@Override
	public String createTable() {
		return "CREATE TABLE IF NOT EXISTS 'payment' (" +
				"'id' INTEGER PRIMARY KEY AUTOINCREMENT, " +
				"'name' TEXT);";
	}

	/**
	 * Erzeugt die Datenbank-Abfrage, um ein neues Zahlungsmittel in die Tabelle
	 * "payment" zu speichern. Diese Abfrage enthält bereits den Namen. Wird
	 * <b>null</b> als Parameter übergeben, so wird als Platzhalter für den
	 * Namen ein <b>?</b> eingefügt.
	 * 
	 * @param name Name des neuen Zahlungsmittels.
	 * 
	 * @return Datenbank-Abfrage, um ein neues Zahlungsmittel zu erstellen.
	 */
	 ...
	 * Namen ein <b>?</b> eingefügt.
	 * 
	 * @param name Name des neuen Zahlungsmittel.
	 * 
	...
	/**
	 * Erzeugt die Datenbank-Abfrage, um ein Zahlungsmittel in der Tabelle
	 * "payment" zu ändern. Wurde eine ID größer <b>-1</b> angegeben, so wird
	 ...
	 * 
	 * @param name Neuer Name des Zahlungsmittels
	 * 
