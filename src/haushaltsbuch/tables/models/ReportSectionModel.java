 ...
 * @since 0.2
 */
public class ReportSectionModel extends ReportModel {

	/**
	 * Serilisation ID
	 */
	private static final long serialVersionUID = 120523847711696293L;
	 ...
	 * @param data
	 */
	public ReportSectionModel(ReportData data) {
		super(data);
	}
	...
	public Object getValueAt(int col, int row) {
		switch (row) {
			// Kategorie
			case 0:
				return ((ReportSectionData)_data).getSection(col);
